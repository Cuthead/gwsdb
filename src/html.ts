...
// chrome (NAV_ZH).
const DEFAULT_DESCRIPTION = "Community-maintained database of Google Web Server (GWS) IPs reachable from China, with PTR/ASN lookups, on-demand probes, and check history.";
